...
<div class="about section">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-xs-12">
        <img class="img-fluid float-right" src="<?php echo base_url(); ?>assets/img/about/img1.jpg" alt="">
      </div>
    </div>
  </div>
</div>
        ...
        <div id="testimonials" class="touch-slider owl-carousel">
          <div class="item">
            <div class="testimonial-item">
              <div class="author">
                <div class="img-thumb">
                  <img src="<?php echo base_url(); ?>assets/img/testimonial/image1.png" alt="">
                </div>
              </div>
          ...
          <div class="item">
            <div class="testimonial-item">
              <div class="author">
                <div class="img-thumb">
                  <img src="<?php echo base_url(); ?>assets/img/testimonial/image2.png" alt="">
                </div>
              </div>
              <div class="content-inner">
          ...
          <div class="item">
            <div class="testimonial-item">
              <div class="author">
                <div class="img-thumb">
                  <img src="<?php echo base_url(); ?>assets/img/testimonial/image3.png" alt="">
                </div>
              </div>
              <div class="content-inner">
